...
1. Download `PowerSaver-v1.0.1.apk` from the [v1.0.1 release](https://github.com/jameswagar/TCL-Flip-2-Power-Saver-Toggle/releases/tag/v1.0.1).
2. Transfer and install it:

   ```sh
   adb install PowerSaver-v1.0.1.apk
   ```
...
The APK is written to `dist/PowerSaver-v1.0.1.apk`.
...
The host-side tests cover reversible Airplane Mode and radio planning, selected-option behavior, charging preconditions, shell construction and ordering, verification markers, and rollback construction.
